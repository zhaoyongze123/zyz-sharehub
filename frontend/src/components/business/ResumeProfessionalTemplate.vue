...
const theme = {
  ...
  basicHeaderClass: 'flex items-start gap-5',
  basicTitleWrapClass: 'flex flex-col items-center gap-1.5 text-center',
  nameClass: 'text-3xl font-normal tracking-[0.25em] text-[#3775a6]',
  intentClass: 'text-sm text-gray-500',
  metaGridClass: 'grid grid-cols-2 gap-x-4 gap-y-1 text-sm',
